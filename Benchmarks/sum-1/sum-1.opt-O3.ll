...
define dso_local range(i32 0, 2) i32 @init(i32 noundef %0) local_unnamed_addr #3 {
  ...
  %2 = sext i32 %0 to i64
  %3 = tail call ptr @calloc(i64 noundef %2, i64 noundef 4) #9
  store ptr %3, ptr @ima, align 8, !tbaa !14
  %.not = icmp eq ptr %3, null
  br i1 %.not, label %InitArray.exit18, label %4

4:                                                ; preds = %1
  %5 = tail call ptr @calloc(i64 noundef %2, i64 noundef 4) #9
...
7:                                                ; preds = %4
  %8 = tail call ptr @calloc(i64 noundef %2, i64 noundef 4) #9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %6, align 4, !tbaa !9
  %7 = getelementptr inbounds i32, ptr %4, i64 %index
  %wide.load13 = load <4 x i32>, ptr %7, align 4, !tbaa !9
  %8 = add nsw <4 x i32> %wide.load13, %wide.load
  %9 = getelementptr inbounds i32, ptr %5, i64 %index
  store <4 x i32> %8, ptr %9, align 4, !tbaa !9
...
middle.block:                                     ; preds = %vector.body
  %12 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %10)
